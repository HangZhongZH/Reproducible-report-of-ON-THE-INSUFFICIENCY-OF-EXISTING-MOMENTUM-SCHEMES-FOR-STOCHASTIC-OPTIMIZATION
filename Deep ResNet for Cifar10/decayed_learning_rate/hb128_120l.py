 ...
 # optimizer.step()              
  ...
  for epoch in range(args.start_epoch, args.epochs):
    ...
    #val_acc,   val_los   = extract_features(test_loader, net, criterion, log)
      ...
      }, is_best, args.save_path, 'hb128_120lcheck1.pth.tar')

    # measure elapsed time
      epoch_time.update(time.time() - start_time)
      start_time = time.time()
      recorder.plot_curve( os.path.join(args.save_path, 'hb128_120l1.png') )
...
def save_checkpoint(state, is_best, save_path, filename):
  ...
  if is_best:
    bestname = os.path.join(save_path, 'hb128_120lmodel1.pth.tar')
